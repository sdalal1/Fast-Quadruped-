...
# Get joint IDs
try:
    bthigh_id = sim.model.joint_name2id('bthigh')
    bshin_id = sim.model.joint_name2id('bshin')
    bfoot_id = sim.model.joint_name2id('bfoot')
    fthigh_id = sim.model.joint_name2id('fthigh')
    fshin_id = sim.model.joint_name2id('fshin')
    ffoot_id = sim.model.joint_name2id('ffoot')
